...
```bash
python3 .claude/skills/design-experiment/helpers.py setup-dir "<research_question>"
```
...
python3 .claude/skills/design-experiment/helpers.py power --test two-means --effect-size 0.2 0.5 0.8 --power 0.80 0.90 --cells 2

# Two proportions:
python3 .claude/skills/design-experiment/helpers.py power --test two-proportions --effect-size 0.3 0.5 --power 0.80 0.90

# Multiple groups (ANOVA):
python3 .claude/skills/design-experiment/helpers.py power --test anova --effect-size 0.10 0.25 0.40 --power 0.80 0.90 --cells 3
```
